...
class StudentYearController extends Controller
{
    ...
    public function StudentYearStore(Request $request){
        ...
        $data = new StudentYear();
            ...
            return redirect()->route('student.year.veiw')->with($notification);
    ...
    public function StudentYearUpdate(Request $request,$id){
        ...
        $validatedData = $request->validate([
            ...
            $notification = array('message' =>'Student Year Updated Successfully ' , 'alert-type'=>'success' );
            return redirect()->route('student.year.veiw')->with($notification);
    ...
    public function StudentYearDelete($id){
        ...
        $notification = array('message' =>'Student Year Deleted Successfully ' , 'alert-type'=>'success' );
            return redirect()->route('student.year.veiw')->with($notification);
