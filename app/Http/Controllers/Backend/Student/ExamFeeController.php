...
class ExamFeeController extends Controller
{
    ...
    public function ExamFeeView()
    {
     ...
     return view('Backend.Student.ExamFee.Exam_Fee_view',$data);
 ...
 public function ExamFeeClassWise(Request $request){
     ...
     $allStudent = AssignStudents::with(['discount'])->where($where)->get();
     // dd($allStudent);
     ...
     foreach ($allStudent as $key => $v) {
         ...
         href="'.route("exam.fee.payslip").'?class_id='.$v->class_id.
 ...
 public function ExamFeePaySlip(Request $request)
 {
     ...
     $pdf = FacadesPdf::loadView('Backend.Student.ExamFee.Exam_Fee_PDF', $data);
