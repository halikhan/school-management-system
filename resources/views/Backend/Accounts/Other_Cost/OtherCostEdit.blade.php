           ...
           <form method="post" action="{{ route('update.other.cost',$editData->id) }}" enctype="multipart/form-data">
            ...
            <div class="row" >  {{--  1st Row Started --}}
			  ...
			  <div class="col-md-3">
				<div class="form-group">
					<div class="controls"> 
					  <img src="{{ (!empty($editData->image))?  url('upload/cost_images/'.$editData->image)
            :url('upload/no_image.jpg') }}" style="height:80px; width:80px; border:1px; solid #000000;">
					</div>
				  </div>
				...
				<div class="col-md-12">
					<div class="form-group">
						...
						<div class="controls">
							...
							placeholder="Your description" aria-invalid="false"> {{ $editData->description }}</textarea>
