			...
			<div class="col-12">
				<div class="box bb-3 border-primary">
				  <div class="box-header">
					<h4 class="box-title">Manage  <strong>Employee Attendence Report</strong></h4>
				  </div>
				  <div class="box-body">

					<form method="GET" action="{{ route('attendence.report.get') }}" target="_blank">
						@csrf 
						<div class="row">
								  ...
								  <div class="controls">
									...
									<select name="employee_id" id="employee_id" required class="form-control">
									  <option value="" selected="" disabled="" >Select Employee</option>
										@foreach ($epmloyees as $epmloyee )
										<option value="{{ $epmloyee->id }}" >{{ $epmloyee->name }} </option>
										@endforeach
