							...
							<tr>
								...
								<td>   
									<img src="{{ (!empty( $value['student']['image']))? 
										url('upload/student_images/'. $value['student']['image']):url('upload/no_image.jpg') }}"
								...
								<td>
									...
									<a target="_blank" title="Details" href="{{ route('Student.reg.details',$value->student_id) }}"
