...
<head>
  <meta charset="utf-8">
    ...
    <title>SMS ERP - Registration </title>
						...
						<div class="p-30 rounded30 box-shadowed b-2 b-dashed">
								  ...
								  <div class="row">
									<div class="col-12">
									  <div class="checkbox text-white">
										<input  type="checkbox" name="password_confirmation" required autocomplete="new-password" 
                                        id="basic_checkbox_1" id="password_confirmation">
							...
							<div class="text-center">
								<p class="mt-15 mb-0 text-white">Already have an account?
                                    <a href="{{ route('login') }}" class="text-danger ml-5"> Sign In</a></p>
							</div>
						</div>
					</div>
				</div>
